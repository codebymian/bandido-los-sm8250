...
#if IS_BUILTIN(CONFIG_QCOM_WATCHDOG_V2)
...
static inline int sec_kn_register_notifier(struct notifier_block *nb,
		int (*notifier_call)(struct notifier_block *, unsigned long, void *)) { return 0; }
